...
public class M1_fun_tv_home_user_VarietyShow {
	private static final Logger logger = LoggerFactory.getLogger("M1_fun_tv_home_user_VarietyShow.class");
...
//	}
	...
	public void testHeaderTab(){
		...
		DriverFactory.sleep();
		//第一个综艺节目-左边第一个
		String js="document.getElementsByClassName(\"tit h\")[2].click()";
		...
		boolean flag =m1_fun_tv_home_skip.cururlHasKeywords("mplay");
		if(true != flag )//说明可以跳到了专题页，需要再次点击播放
		{
			//选择左边第一个开始播放
			String videojs="document.getElementsByClassName(\"pic\")[0].click()";
			m1_fun_tv_home_skip.excutejs(videojs);
		}
