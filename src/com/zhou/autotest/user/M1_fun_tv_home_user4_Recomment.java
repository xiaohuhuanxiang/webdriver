...
public class M1_fun_tv_home_user4_Recomment {
	private static final Logger logger = LoggerFactory.getLogger("M1_fun_tv_home_user4_Recomment.class");
...
//	}
	...
	public void testVplay(){
		Reporter.log(m1_fun_tv_home_skip.getCurrentUrl(),true);
		DriverFactory.sleep();
		// 推荐
		//【今日热播】第一个
