...
public class M1_fun_tv_home_user6_VideoLibrary {
	private static final Logger logger = LoggerFactory.getLogger("M1_fun_tv_home_user6_VideoLibrary.class");
...
// 想看电影，进入 电影检索页，
	...
	public void testLocationAndScroll(){
		...
		//1. 定位影视库
		WebElement element =DriverFactory.driver.findElement(By.xpath("//*[@id=\"navWrap\"]/ul/li[23]/a"));
		DriverFactory.sleep();
