...
public class M1_fun_tv_vplay {

	private static final Logger logger = LoggerFactory.getLogger("M1_fun_tv_vplay.class");
...
//	}
	...
	public void testClickSkip(){
		...
		DriverFactory.open(m1_fun_tv_home_common.baseurl+"/vplay/?vid="+m1_fun_tv_home_common.getVplayMid());
