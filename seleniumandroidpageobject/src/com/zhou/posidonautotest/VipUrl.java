...
public class VipUrl {
// vip
	public static final String Vipurl="http://po.funshion.com/v6/config/channelhome?nav_id=50&cl=mweb&uc=30";
	
	
	
	//返回vip的所有筛选条件
	public  static String filtersurl="http://pm.funshion.com/v5/media/filters?channel=8&cl=mweb&uc=30";
	public static final String retrievalurl="http://pm.funshion.com/v5/media/retrieval?cl=mweb&uc=30&channel=8&order=pl&cate=0&area=0&year=0&pg=1&sz=42";
