 ...
 */
	public static void main(String[] args) {
		...
		classes.add(new XmlClass("com.zhou.autotest.channel.M1_fun_tv_home_cookiesAndLocalStorage"));
		classes.add(new XmlClass("com.zhou.autotest.channel.M1_fun_tv_mplay"));
		classes.add(new XmlClass("com.zhou.autotest.channel.M1_fun_tv_mplay_bigtosmall"));
		classes.add(new XmlClass("com.zhou.autotest.channel.M1_fun_tv_vplay"));
		classes.add(new XmlClass("com.zhou.autotest.channel.M1_fun_tv_vplay_malliance"));
		classes.add(new XmlClass("com.zhou.autotest.parter.M1_fun_tv_vplay_parterOnePoint"));// 一点资讯
		classes.add(new XmlClass("com.zhou.autotest.parter.M1_fun_tv_vplay_parter")); //小知  播放页
